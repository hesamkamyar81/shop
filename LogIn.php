...
<h3 style="padding: 10px 10px;" class="text-left text-primary bg-info">ورود</h3>
	<form style="padding: 10px 10px;" class="bg-info" method="post" action="LogIn.php">
		...
		<br />
        <a style="color: darkred;" href="SignUp.php">هنوز ثبت نام نکرده ام؟</a><br /><br />
        <a style="color: darkred;" href="admin/forget-password.php">رمز عبور خود را فراموش کرده اید ؟</a><br /><br />

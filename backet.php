...
<div class="container">
        ...
        <tr>
            ...
            <td>
                <a href="admin/images/<?php echo $row['image'];?>">
                    <img title="برای دیدن کامل تصویر روی آن کلیک کنید" style="width: 50px;height: 50px;" src="admin/images/<?php echo $row['image'];?>" >
                </a>
            </td>
            <td><?php echo $row['description'];?></td>
            <td><?php echo number_format($row['price']) . ' تومان ';?></td>
            <td style="text-align: center;font-size: 18px;">
                <a style="color: brown;" href="admin/del-backet.php?pid=<?php echo $row['pid'];?>&uid=<?php echo $uid;?>">حذف</a>
            </td>
        </tr>
        <?php
		endwhile;?>
    ...
    <?php if(isset($_GET['del']) && $_GET['del'] == 'ok'):?>
        <h3 style="color: green;">محصول با موفقیت از سبد خرید حذف شد</h3>
    <?php endif;?>
    <?php if(isset($_GET['del']) && $_GET['del'] != 'ok'):?>

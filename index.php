...
<div class="row">
    <form action="search.php" method="get">
        <input style="margin-right: 20px;" type="search" name="search" placeholder="کلمه مورد نظر ...">
...
<div class="row">
    <form action="filter.php" method="get">
        <b style="margin-right: 20px;"> قیمت از</b>
        <select name="n1" id="">
        ...
        <b style="margin-right: 20px;">تا</b>
        <select name="n2" id="">
            <option value="1000000">1,000,000 تومان</option>
            <option value="1500000">1,500,000 تومان</option>
        ...
        <input type="submit" name="sub1" value="جستجو">
    </form>
</div>
</div>
    <style>
...
<div class="row">
    ...
    <div class="container">
        ...
        <a href="post.php?id=<?php echo $row['id'];?>">
            <img style="height: 200px;width: 280px;margin-top: 3pt;" class="img-responsive img-thumbnail" src="admin/images/<?php echo $row['image'];?>" alt="image-product" id="image-product"/>
        </a>
        <?php endif;?>
        <?php if ($row['status'] == 0):?>
            <a href="index.php">
